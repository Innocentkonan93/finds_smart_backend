...
@section('content')
    ...
    <div class="card basic-data-table radius-12 overflow-hidden">
        <form action="{{ route('updateTermsCondition', $page->id) }}" method="POST" onsubmit="document.querySelector('#editor-content').value = document.querySelector('#editor .ql-editor').innerHTML;">
            @csrf
            @method('PUT')
