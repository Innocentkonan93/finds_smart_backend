...
<body>
    ...
    <section class="auth bg-base d-flex flex-wrap">
        <div class="auth-left d-lg-block d-none" style="background-image: url('https://images.unsplash.com/photo-1747640763510-3770f1a02046?q=80&w=2274&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'); background-size: cover; background-position: center;">
        ...
        <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center">
            <div class="max-w-464-px mx-auto w-100">
                <div>
                    ...
                    <h4 class="mb-12">Connectez-vous </h4>
                    <p class="mb-32 text-secondary-light text-lg">Bienvenue de nouveau ! Veuillez entrer vos informations</p>
                </div>
